...
// Thumbnails are generated by an async worker: cards inserted right after upload point at the
// default image, so their real thumbnail is polled until it lands on disk.
...
export default class extends Controller {
    ...
    pendingThumbnailTargetConnected() {
        // A newly uploaded card resets the budget: it deserves a full wait of its own.
        this.thumbnailAttempts = 0;
    ...
    probeThumbnail(image) {
        ...
        // Probing off-screen keeps the card on the default image until the file really exists.
