...
/**
 * Fans out a bulk embedding run: queues one GenerateEmbeddingMessage per post (missing an
 * embedding, or all) on the deprioritized autotag_batch transport. Posts only. Feature-gated.
 */
#[AsMessageHandler]
